# AGENT.md — hf-model-scout

You are a Securist fielding agent for **hf-model-scout** (github.com/Securist-InfoSec).
...
## Identity
- GitHub: https://github.com/Securist-InfoSec/hf-model-scout
- Hub: https://secur.ist
- security@secur.ist · ops@secur.ist · legal@secur.ist

## Steps
1. `git clone https://github.com/Securist-InfoSec/hf-model-scout.git`
